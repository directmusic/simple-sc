...
extern void start_pipewire_capture(int fd, uint32_t node_id, struct pw_properties* stream_properties, XdpSession* g_session);
...
int main(int argc, char* argv[]) {
    ...
    start_pipewire_capture(g_pipewire_fd, g_pipewire_node_id, pw_properties_new(PW_KEY_MEDIA_TYPE, "Video", PW_KEY_MEDIA_CATEGORY, "Capture", PW_KEY_MEDIA_ROLE, "Screen", NULL), g_session);
